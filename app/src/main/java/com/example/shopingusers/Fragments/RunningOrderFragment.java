...
public class RunningOrderFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_running_order, container, false);
    }
                ...
                if(snapshot.exists()) {
                    ...
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        if(dataSnapshot.child("status").exists()) {
                            if(!dataSnapshot.child("status").getValue().equals("Completed") && !dataSnapshot.child("status").getValue().equals("Cancelled") ) {
